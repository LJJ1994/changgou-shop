...
public class RabbitMQConfig {
    ...
    public Exchange AD_UPDATE_EXCHANGE(){
        return ExchangeBuilder.fanoutExchange(AD_UPDATE_EXCHANGE).durable(true).build();
    }
    ...
    //队列与交换机的绑定
    @Bean
    public Binding AD_UPDATE_EXCHANGE_BINDING(@Qualifier(AD_UPDATE_QUEUE)Queue queue,@Qualifier(AD_UPDATE_EXCHANGE)Exchange exchange){
